...
SYS_OBJECTS = $(SDK)/mbed/TARGET_ARCH_PRO/TOOLCHAIN_GCC_CS/*.o
...
LIBRARY_PATHS = -L$(SDK)/mbed/TARGET_ARCH_PRO/TOOLCHAIN_GCC_CS
LIBRARIES = -lmbed
LINKER_SCRIPT = $(SDK)/mbed/TARGET_ARCH_PRO/TOOLCHAIN_GCC_CS/LPC1768.ld
